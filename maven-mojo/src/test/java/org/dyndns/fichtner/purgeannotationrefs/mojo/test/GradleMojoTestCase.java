...
public class GradleMojoTestCase extends PlexusTestCase {
  ...
  protected void setUp()
    ...
    InputStream is = getClassLoader().getResourceAsStream("/" + getPluginDescriptorLocation());

    XmlStreamReader reader = new XmlStreamReader(is);

    InterpolationFilterReader interpolationFilterReader =
        new InterpolationFilterReader(new BufferedReader(reader), container.getContext().getContextData().entrySet().stream().collect(Collectors.toMap(Object::toString, Function.identity())));
